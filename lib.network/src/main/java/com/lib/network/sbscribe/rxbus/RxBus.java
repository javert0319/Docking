package com.lib.network.sbscribe.rxbus;
    ...
    public static Subscriber<Object> defaultSubscriber() {
        return new Subscriber<Object>() {
            ...
            public void onNext(Object o) {
                L.d(TAG, "New event received: " + o);
            }

            @Override
            public void onError(Throwable t) {
                L.e(TAG, "What is this? Please solve thisat is this? Please solve thi as soon as possible!", t);
            }
