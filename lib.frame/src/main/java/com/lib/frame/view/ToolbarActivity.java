...
public abstract class ToolbarActivity extends RxAppCompatActivity implements OnKeyboardListener {
    ...
    protected View initToolbar(String title, boolean displayHomeEnable) {
        return initToolbar(title,displayHomeEnable, false);
    }

    protected View initToolbar(String title, boolean displayHomeEnable,boolean keyboardEnable) {
        ...
        if (toolbarInitialized) {
            ...
            return TitleBarControlCenter.initTitle(this, decorView, title, displayHomeEnable,this,keyboardEnable);
        }
    }
