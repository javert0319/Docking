...
public abstract class ToolbarFragment extends RxFragment implements OnKeyboardListener {
    ...
    protected View initToolbar(View rootView, String title, boolean displayHomeEnable) {
        return initToolbar(rootView, title, displayHomeEnable, false);
    }
     ...
     * @return
     */
    protected View initToolbar(View rootView, String title, boolean displayHomeEnable, boolean keyboardEnable) {
        ...
        if (useActivityToolbar) {
            ...
            if (getActivity() instanceof OnKeyboardListener) {
                return TitleBarControlCenter.initTitle(getActivity(), rootView, title,
                        displayHomeEnable, (OnKeyboardListener) getActivity(), keyboardEnable);
            } else {
                return TitleBarControlCenter.initTitle(getActivity(), rootView, title,
                        displayHomeEnable, this, keyboardEnable);
            }
        }
    }
